                                ...
                                <form action="">
                                    ...
                                    <div class="py-3 px-1 border-b border-gray-300 mb-8">
                                        ...
                                        <div class="flexbox-container cont2">
                                            <a href=""><button type="button" class=" inline-block px-10 py-10 bg-indigo-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-40 pb-14">Entry IRS</button></a>
