            ...
            <div class="card-body">
                <form method="POST" action="" class="grid gap-7">
                    ...
                    <div class="form-group">
                        ...
                        <input name="SKS Kumatif" class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="number" placeholder="Masukkan SKS Kumulatif">
                    </div>
                    <div class="form-group">
                        <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="grid-city">
                            Upload Scan KHS
