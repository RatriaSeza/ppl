...
<div class="container text-start">
    <div class="row align-items-start">
        ...
        <div class="col-8">
            ...
            <p style="margin-top:30px">Detail Data Mahasiswa Perwalian Tiap Angkatan</p>
            ...
            <p style="margin-top:50px">Daftar Mahasiswa Perwalian PKL</p>
            <div class="bg-light border border-dark"
                style="width:40%;transform:rotate(-90deg);transform-origin:center;margin-left:150px;margin-top:-120px;padding-bottom:70px;padding-top:50px;padding-right:30px">
                <div class="container text-end">
                    <div class="row align-items-start">
            ...
            <div style="margin-top:-150px">
            <p style="margin-top:50px">Daftar Mahasiswa Perwalian Skripsi</p>
            <div class="bg-light border border-dark"
                style="width:40%;transform:rotate(-90deg);transform-origin:center;margin-left:150px;margin-top:-120px;padding-bottom:70px;padding-top:50px;padding-right:30px">
                <div class="container text-end">
                    <div class="row align-items-start">
            ...
            <br>
            <button type="button" class="btn btn-primary" style="background: #07F0FF;width:300px">Edit Data Mahasiswa Perwalian</button>
            
            <button type="button" class="btn btn-primary" style="background: #613fe5;width:300px">Cetak Data Mahasiswa Perwalian</button>
