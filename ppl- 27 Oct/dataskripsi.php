...
<div class="col">
    <p style="margin-top:30px">Overview Data Mahasiswa Skripsi</p>
    ...
    <p style="margin-top:30px">Rekap Mahasiswa Skripsi Tiap Angkatan</p>
    ...
    <br>
    <button type="button" class="btn btn-primary" style="background: #07F0FF;width:250px">Preview</button>
    
    <button type="button" class="btn btn-primary" style="background: #613fe5;width:250px">Print</button>
