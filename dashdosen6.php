...
<div class="grid grid-cols-3 gap-1">
    ...
    <!-- Link 1-->
        <div class="max-w-sm bg-white rounded-lg border border-purple-200 shadow-md dark:bg-purple-600 dark:border-purple-700">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Detail Data Mahasiswa Perwalian</h5>
                </a>
    ...
    <!-- Link 2-->
        <div class="max-w-sm bg-white rounded-lg border border-purple-200 shadow-md dark:bg-purple-600 dark:border-purple-700">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Verifikasi Mahasiswa Perwalian</h5>
                </a>
    ...
    <!-- Link 3 -->
        <div class="max-w-sm bg-white rounded-lg border border-purple-200 shadow-md dark:bg-purple-600 dark:border-purple-700">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Progres Belajar Mahasiswa Perwalian</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-100">IRS, KHS, PKL, dan Skripsi</p><br/>
                <a href="#" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Show more
        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
                ...
                <strong>Grafik Mahasiswa Perwalian Tiap Angkatan</strong>
                </div>
            </div>
        </div>
